...
import { Card, Text, Metric, Flex, Badge, Table, TableBody, TableRow, TableCell, TableHeaderCell, TableHead, Title } from '@tremor/react';
import { Publication } from '../instructors/[id]/page';
import { useState } from 'react';



export default function PublicationTableOnInstructor({ data }: { data: Publication[] }) {
