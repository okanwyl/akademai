'use client';
import {  Text,  Badge, Table, TableBody, TableRow, TableCell, Title, TableHead, TableHeaderCell, Divider } from '@tremor/react'; import { Course, Instructor } from '../instructors/[id]/page';
