import { Card, Title, Text, Grid, Flex, Metric, BarList, Bold, DonutChart } from "@tremor/react";
...
async function getInstructorMetric(id: number) {
    const res = await fetch(`http://89.252.131.124:8080/api/instructor/${id}/metric`)
...
export default async function InstructorsPage({ params }: { params: { id: string } }) {
