'use client'
import { Text, Table, TableBody, TableRow, TableCell, Badge, Divider, Title, TableHead, TableHeaderCell, Bold } from "@tremor/react";
import Link from "next/link";
import { Instructor } from "../instructors/[id]/page";

export default async function InstructorAllTable({ data }: { data: Instructor[] }) {
    return (
      <>
